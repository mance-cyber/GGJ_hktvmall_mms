    ...
    <div className="space-y-8 animate-fade-in-up p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Badge variant="outline" className={cn(
          ...
          {config?.api_key_set ? (
            <>
              <CheckCircle2 className="w-3 h-3 mr-1" /> API 已設定
            </>
          ) : (
            <>
              <AlertCircle className="w-3 h-3 mr-1" /> API 未設定
            </>
          )}
        </Badge>
      </div>
      ...
      <motion.div
        ...
        className="glass-panel rounded-2xl p-6 border border-white/40"
      >
      ...
      <motion.div
        ...
        className="glass-panel rounded-2xl p-6 border border-white/40 bg-gradient-to-br from-slate-50/50 to-transparent"
      >
